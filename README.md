...
A laptop failure destroyed the only copy of several loan files.
A junior staff member turned out to have access to high-net-worth client records completely unrelated to their role.
Every quarter, audit documents were emailed to external auditors as attachments - and copies still sit in those auditors' inboxes today, unrecoverable.
